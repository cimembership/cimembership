...
use CIMembership\Models\LoginAttemptModel;
use CIMembership\Models\UserProfileModel;
use Config\Services;

/**
 * CIMembership Authentication Library
 *
 * Provides login/logout, session management, permission checking,
 * and remember-me functionality for CodeIgniter 4 applications.
 *
